        ...
        if (typeof opt.onWarn !== 'function') {
            ...
            var coundownBarHtml = opt.countdownBar ?
                '<div class="progress" style="height: 15px !important;"> \
                  <div class="progress-bar progress-bar-striped countdown-bar active" role="progressbar" style="min-width: 15px; width: 100%; height: 15px !important;"> \
              ...
              <div class="modal-dialog"> \
                <div class="modal-content"> \
                  ...
                  <div class="modal-footer"> \
                    ...
                    <button onclick="keepAliveDirect();" id="session-timeout-dialog-keepalive" type="button" class="btn btn-primary" data-dismiss="modal">' + opt.keepAliveButton + '</button> \
                  </div> \
                </div> \
              </div> \
             </div>');
                ...
                headers: {
      					...
      					success: function(respuesta){
      						if(respuesta[0].resp='correcto'){
      							...
      							alerta('Alerta!','session-timeout file Framedev 001');
      						}
      					},
