  ...
  <div class="row">
    <div class="col-lg-12">
      ...
      <div class="m-portlet">
        ...
        <div class="m-portlet__body">
          ...
          <form id="datos_beneficiario">
            <div class="tab-content">
                  <div class="tab-pane active" id="m_tabs_1_1" role="tabpanel">
                    ...
                    <div class="form-group m-form__group row">
                      <label for="example-text-input" class="col-12 col-sm-12 col-md-2 col-form-label">
                      ...
                      <div class="col-12 col-sm-12 col-md-3">
                          <select class="form-control m-select2" id="id_nacionalidad" name="id_nacionalidad"><?=$datos['nacionalidades']?></select>
                      </div>
                    </div>
                    <div class="form-group m-form__group row">
                      <label for="example-text-input" class="col-12 col-sm-12 col-md-2 col-form-label">
                  ...
                  <div class="tab-pane" id="m_tabs_1_2" role="tabpanel">
                    ...
                    <div class="form-group m-form__group row">
                      <label for="example-text-input" class="col-12 col-sm-12 col-md-1 col-form-label">
                        A Paterno
                      </label>
                      <div class="col-12 col-sm-12 col-md-3">
                    ...
                    <div class="form-group m-form__group row">
                      ...
                      <div class="col-12 col-sm-12 col-md-3">
                        <select class="form-control m-select2" id="id_pais_residencia" name="id_pais_residencia" style="width: 100%;">
                          <?=$datos['paises2']?>
                        </select>
                      </div>
                    </div>
                  ...
                  <div class="tab-pane" id="m_tabs_1_3" role="tabpanel">
                    ...
                    <div class="form-group m-form__group row">
                      ...
                      <label class="col-12 col-sm-12 col-md-1 col-form-label">
                        Actividad
                      </label>
                      <div class="col-12 col-sm-12 col-md-3">
                      ...
                      <div class="col-12 col-sm-12 col-md-3 input-group" style="width: 100%;">
            ...
            <input type="hidden" value="<?=$datos['id_beneficiario']?>" name="id_beneficiario" id="id_beneficiario">
            <input type="hidden" value="<?=$datos['forma_pago']?>" name="forma_pago" id="forma_pago">
          </form>

          <div class="m-portlet__foot m-portlet__foot--fit">
            <div class="m-form__actions">
              <div class="row">
                <div class="col-1 col-sm-1 col-md-9"></div>
                <div class="col-11 col-sm-11 col-md-3"><br><br><br>
      ...
      jQuery(document).ready(function() {
          ...
          <?php if($datos['forma_pago'] == 66){?> window.onload = validarClabe(document.getElementById("CLABE")); <?php } ?>
      });
      </script>
