...
$("#breadcrumb-title").append(' / Duplicados en Unificada');
</script>
<style>
#breadcrumb-title{
	padding-left: 60px;
...
<div class="m-portlet m-portlet--mobile">
	...
	<div class="m-portlet__body">
		<table id="unificadadup" class="table table-striped table-bordered display responsive nowrap" cellspacing="0" width="100%">
			<thead>
				<tr>
					<th>id</th>
					<th>Nombre</th>
...
$(document).ready(function() {
    $('#unificadadup').dataTable( {
			"dom": 'Blfrtip',
			"buttons": [
					{
					'extend': 'csv',
					'filename': 'unificadadup'
					},
				{
					'extend': 'excel',
					'filename': 'unificadadup'
