...
$("#breadcrumb-title").append(' /Duplicados en CNB-CBP');
</script>
<style>
#breadcrumb-title{
	padding-left: 60px;
...
<div class="m-portlet m-portlet--mobile">
	...
	<div class="m-portlet__body">
		<table id="cnbcbpdup" class="table table-striped table-bordered display responsive nowrap" cellspacing="0" width="100%">
			<thead>
				<tr>
					<th>id</th>
					<th>Nombre</th>
