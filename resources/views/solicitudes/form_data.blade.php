  ...
  <div class="row">
    <div class="col-lg-12">
          ...
          <form id="datos_asegurado">
            <div class="tab-content">
                    ...
                    <div class="form-group m-form__group row">
                      ...
                      <div class="col-12 col-sm-12 col-md-3 input-group" style="width: 100%;">
                        <div class="m-input-icon m-input-icon--right">
                          <input type="text" class="form-control m-input" id="telefono" oninput="validarTel(this)"  name="telefono" value="<?=$datos['telefono']?>">
                  ...
                  <div class="tab-pane" id="m_tabs_1_4" role="tabpanel">
                    ...
                    <div class="form-group m-form__group row">
                      <label for="example-text-input" class="col-12 col-sm-12 col-md-4 col-form-label">
          ...
          <div class="m-portlet__foot m-portlet__foot--fit">
            <div class="m-form__actions">
              <div class="row">
                ...
                <div class="col-11 col-sm-11 col-md-5"><br><br><br>
      ...
      jQuery(document).ready(function() {
          window.onload = validarTel(document.getElementById("telefono"));
