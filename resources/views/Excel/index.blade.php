        ...
        <div class="m-card-profile">
          ...
          <div class="m-card-profile__details">
            ...
            <a href="javascript:void(0);" class="m-card-profile__email m-link">
              Arrastre un archivo de excel para comprobar su validez
            </a>
          </div>
        </div>
                ...
                <div class="m-dropzone dropzone" id="m-dropzone-one">
                  <div class="m-dropzone__msg dz-message needsclick">
                    <h3 class="m-dropzone__msg-title">
                      Arrastra aqui el archivo para verificar su validez.
                    </h3>
...
$(document).ready(function() {
  $("#m-dropzone-one").dropzone({
    url: "excel/upload_verifing/excel/index",<?php //excel/upload_verifing/estructura|del|directorio/permisos ?>
    paramName: "file",
    maxFiles: 1,
    maxFilesize: 128, // MB
    ...
    init: function() {
      this.on("success", function(statics,file) {
        var img = file.split("|");
        $.post( "excel/verifing/" + img[1], function( data ) {
           //swal(data, '', "Upload")
