...
<script src="<?=env('APP_URL')?>assets/app/js/dashboard.js" type="text/javascript"></script>
<script src="<?=env('APP_URL')?>assets/vendors/custom/fullcalendar/fullcalendar.bundle.js" type="text/javascript"></script>


<!--Internacionalizacion para calendario datepicker -->
<script src="<?=env('APP_URL')?>assets/vendors/base/spanish_ui.js" type="text/javascript"></script>
...
<!-- JQuery Plugins-->
<script src="<?=env('APP_URL')?>assets/plugins/bootstrap-sessiontimeout/bootstrap-session-timeout.js?v=2.0" type="text/javascript"></script>
...
<!--<script scr="<?=env('APP_URL')?>assets/plugins/bootstrap-wizard/jquery.bootstrap.wizard.js" type="text/javascript"></script>-->

<!--Sweet Alert-->
<script src="<?=env('APP_URL')?>assets/plugins/bootstrap-sweetalert/sweetalert.min.js"></script>

<!--Dropzone-->
<script src="<?=env('APP_URL')?>assets/js/dropzone.js"></script>
<script src="<?=env('APP_URL')?>assets/demo/default/custom/components/forms/widgets/dropzone.js" type="text/javascript"></script>

<!--Datatables-->
<script src="<?=env('APP_URL')?>assets/vendors/custom/datatables/datatables.bundle.js" type="text/javascript"></script>
<script src="<?=env('APP_URL')?>assets/demo/default/custom/crud/datatables/basic/basic.js" type="text/javascript"></script>


<!--fontawesome-pro-5.0.0 load everything!!-->
<script src="<?=env('APP_URL')?>assets/fontawesome-pro-5.0.0/svg-with-js/js/fontawesome-all.js" type="text/javascript"></script>
<script defer src="<?=env('APP_URL')?>assets/fontawesome-pro-5.0.0/svg-with-js/js/fa-v4-shims.js"></script>

<!--Autocomplete-->
<script src="<?=env('APP_URL')?>assets/js/jquery.autocomplete.js"></script>
...
<script src="<?=env('APP_URL')?>assets/js/roles.js"></script>
